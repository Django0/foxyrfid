...
/** @ingroup EXAMPLES_USBDROM_11UXX_HID_I2C
 * @{
 */
...
/**
 * @brief	HID_I2C interface init routine.
 ...
 * @param	pI2C	    : Pointer to I2C port, this HID instance needs to bind.
 * @param   pI2CHid     : Pointer to HID_I2C handle returned on success
...
/**
 * @brief	Process HID_I2C request and response queue.
 * @param	hI2CHid		: Handle to HID_I2C instance
 */
