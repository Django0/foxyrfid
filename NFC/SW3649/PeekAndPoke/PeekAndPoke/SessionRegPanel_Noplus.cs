...
{
    public partial class SessionRegPanel_Noplus : Form
    {
        ...
        private void updateRead_NC_REG(object sender, EventArgs e)
        {
            if (this.myDevice.isPresent)
            {
                ...
                if (error == I2CError.Success)
                {
                    ...
                    // Update the GUI
                    this.I2C_RST_CheckBox.Checked = (readRegister & 0x80) == 0x80; // I2C_RST_ON_OFF
        ...
        private void write_NC_REF(object sender, EventArgs e)
        {
            if (this.myDevice.isPresent)
            {
                ...
                writeRegister += (byte)(this.I2C_RST_CheckBox.Checked ? 0x80 : 0); // I2C_RST_ON_OFF
