...
{
    public partial class ConfigRegPanel : Form
    {
        ...
        private void readConfigRegAndShow(object sender, EventArgs e)
        {
            if (this.myDevice.isPresent)
            {
                ...
                if (error == I2CError.Success)
                {
                    ...
                    // Update the GUI
                    // NC_REG
                    this.I2C_RST_CheckBox.Checked = (readRegisters[(int)ConfigReg.NC_REG] & 0x80) == 0x80; // NFCS_I2C_RST_ON_OFF
        ...
        private void writeFormValuesToConfigReg(object sender, EventArgs e)
        {
            if (this.myDevice.isPresent)
            {
                ...
                // NC_REG
                writeRegisters[(int)ConfigReg.NC_REG] += (byte)(this.I2C_RST_CheckBox.Checked ? 0x80 : 0); // NFCS_I2C_RST_ON_OFF
